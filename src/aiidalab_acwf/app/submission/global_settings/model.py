...
from aiidalab_acwf.common.code import CodeModel, PwCodeModel
from aiidalab_acwf.common.mixins import HasInputStructure
from aiidalab_acwf.common.panel import ResourceSettingsModel
from aiidalab_acwf.common.widgets import QEAppComputationalResourcesWidget
    ...
    def _check_blockers(self):
        ...
        for identifier, code_model in self.get_models():
            ...
            if not issubclass(
                ...
                yield (
                    f"Error: hi, plugin developer, please use the QEAppComputationalResourcesWidget from aiidalab_acwf.common.widgets for code {identifier}."
                )
