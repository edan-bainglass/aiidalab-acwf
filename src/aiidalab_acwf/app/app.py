...
from aiidalab_acwf import __version__
from aiidalab_acwf.common.guide_manager import guide_manager
from aiidalab_acwf.common.infobox import InAppGuide, InfoBox
...
class AppView(ipw.VBox):
    ...
    def __init__(self) -> None:
        ...
        title = ipw.HTML("<h1>AiiDA Common Workflows (ACWF) app</h1>")
        title.add_class("title")

        subtitle = ipw.HTML(
            "<div id='subtitle'>Submit materials science simulation workflows with your quantum engine of choice</div>"
        )
        ...
        self.duplicate_workflow_link = LinkButton(
            ...
            link="./acwf.ipynb?duplicating=True",
            icon="clone",
