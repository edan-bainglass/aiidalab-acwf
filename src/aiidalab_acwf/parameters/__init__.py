...
DEFAULT_PARAMETERS = yaml.safe_load(resources.read_text(__package__, "defaults.yaml"))

CONFIG_DIR_PATH = Path.home() / ".aiidalab" / "acwf"

custom_config_file = CONFIG_DIR_PATH / "config.yaml"
